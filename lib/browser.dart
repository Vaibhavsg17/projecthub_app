...
class _BrowserState extends State<Browser> with SingleTickerProviderStateMixin {
  static const platform =
      MethodChannel('com.pichillilorenzo.projecthub_ai_app.intent_data');
  ...
  void didChangeDependencies() {
    ...
    precacheImage(const AssetImage("assets/icon/sia-logo.png"), context);
  }
  ...
  Widget _buildWebViewTabsContent() {
    ...
    // If no tabs are open, add the default tab with the specified URL
    if (browserModel.webViewTabs.isEmpty) {
      browserModel.addTab(
        WebViewTab(
          key: GlobalKey(),
          webViewModel: WebViewModel(
            url: WebUri("https://projecthub-ai.netlify.app/home"),
